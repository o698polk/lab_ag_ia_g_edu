...
Configura entorno local: venv, .env.example, logging, JWT settings, toolchains.

## Contrato

Entradas: A04, ADR. Salidas: scaffold config sin secretos reales.
