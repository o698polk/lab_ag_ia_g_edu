...
|---|---|
| Código | K-017 |
| Nombre | Academic Domain Engineer |
| Fase primaria | F6 |
| Estado | Registered |
...
Dominio estudiantes, cursos, matrículas, asistencia, notas, kardex.

## Contrato

Entradas: S05 académico, A02. Salidas: services académicos + reglas term CLOSED.
